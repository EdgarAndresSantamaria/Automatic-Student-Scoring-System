...
class Preprocessor:
    ...
    '''
    def __init__(self, sequence_length, preprocess):
...
# ----------------------------------------------------------------
# Lauch loaders
preprocessor = Preprocessor(Sentence_len, preprocess=False)
preprocessor.split_semeval(input_path="/home/edgar/Escritorio/semeval-2013-2-and-3-way/training/2way/",output_path="/home/edgar/Escritorio/semeval-2013-2-and-3-way/no_chunk/")
# load the data
training_set, dev_set, test_set = preprocessor.load_semeval(snli_home="/home/edgar/Escritorio/semeval-2013-2-and-3-way/no_chunk/")
...
loaded_embeddings = preprocessor.load_embeddings(glove_home= "/home/edgar/Escritorio/semeval-2013-2-and-3-way/embeddings/glove.6B.50d.txt")
...
class SimmilarityClassifier:
    ...
    def estimate_grade(self, examples, output_dir, title):
        ...
        print("\n\n correlation report: \n")
        print(" question: {}".format(examples[0]["question"]))
        for example in examples:
            ...
            print(" \n given information:\n\n reference: {} \t\t answer: {} \n score: {} \n\n results:\n\n estimated similarity: {} \t\t estimated score: {} \t\t estimated mark: {} ".format(example["reference_answer"], example["student_answer"], example["grade"], similarity, grade, estimated_mark))
    ...
    def train(self, training_data, dev_data):
        def get_minibatch(dataset, start_index, end_index):
            ...
            hypothesis_vectors = np.vstack([dataset[i]['reference_answer_index_sequence'] for i in indices])
...
# seaarch all correct and incorrect from certain question
examples = search_examples(training_set, 10)
classifier = SimmilarityClassifier(len(word_indices), Sentence_len)
print(tf.__version__) # needed tensorflow 2.x
classifier.train(training_set, dev_set)# 10 epochs computed because is large model ...
...
classifier.estimate_grade(search_examples(training_set[350:400], 10), "/home/edgar/Escritorio/semeval-2013-2-and-3-way/figures/", "1_exp")
classifier.estimate_grade(search_examples(training_set[150:200], 10), "/home/edgar/Escritorio/semeval-2013-2-and-3-way/figures/", "2_exp")
classifier.estimate_grade(search_examples(training_set[250:300], 10), "/home/edgar/Escritorio/semeval-2013-2-and-3-way/figures/", "3_exp")
classifier.estimate_grade(search_examples(training_set[450:500], 10), "/home/edgar/Escritorio/semeval-2013-2-and-3-way/figures/", "4_exp")
classifier.estimate_grade(search_examples(training_set[700:750], 10), "/home/edgar/Escritorio/semeval-2013-2-and-3-way/figures/", "5_exp")
classifier.estimate_grade(search_examples(dev_set, 10), "/home/edgar/Escritorio/semeval-2013-2-and-3-way/figures/", "6_exp")
classifier.estimate_grade(search_examples(test_set, 10), "/home/edgar/Escritorio/semeval-2013-2-and-3-way/figures/", "7_exp")
